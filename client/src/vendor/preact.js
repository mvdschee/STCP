...
function w(n, l, u, i, t, o, r, c, s, a) {
    ...
    for (u.__e = g, h = C; h--; )
        null != x[h] &&
            ('function' == typeof u.type && null != x[h].__e && x[h].__e == u.__d && (u.__d = _(i, h + 1)),
            N(x[h], x[h]));
        ...
        n: if ('function' == typeof H) {
            if (
                ...
                null != H.getDerivedStateFromProps &&
                    (h.__s == h.state && (h.__s = s({}, h.__s)), s(h.__s, H.getDerivedStateFromProps(g, h.__s))),
                (y = h.props),
                (_ = h.state),
                v)
            )
                null == H.getDerivedStateFromProps && null != h.componentWillMount && h.componentWillMount(),
